...
public class TimeArrayDeque {
    ...
    public static final int upperLimitNum = 1000000;
    ...
    public static void timeArrayDequeConstruction() {
        // 创建新的ArrayDeque对象，分别用于存储的N、记录的time和ops
        // 从1000到12800（不要用魔法数字），调用stopwatch函数计算时间和结果
        // 将对应的N、记录的time和ops，存到ArrayDeque对应的索引内
        ...
        ArrayDeque<Integer> beWatchedList = new ArrayDeque<>();
